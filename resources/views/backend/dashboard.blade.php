                ...
                <ul class="products-list product-list-in-box">
                    <li class="item">
                        <div class="product-img">
                            <img src="{{asset('storage/images/noimage.gif')}}" alt="Product Image">
                        </div>
...
@section('scripts')
    ...
    {!! Html::script('bower_components/AdminLTE/plugins/chartjs/Chart.js') !!}
    {!! Html::script('bower_components/AdminLTE/dist/js/pages/dashboard2.js') !!}
